    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('author.posts.update', $post) }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea id="content" name="content" class="mt-1 block w-full" rows="10" required>{{ old('content', $post->content) }}</x-textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea id="excerpt" name="excerpt" class="mt-1 block w-full" rows="3">{{ old('excerpt', $post->excerpt) }}</x-textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="tags" name="tags" type="text" class="mt-1 block w-full" :value="old('tags', $post->tags->pluck('name')->join(', '))" placeholder="tag1, tag2, tag3" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea id="meta_description" name="meta_description" class="mt-1 block w-full" rows="3">{{ old('meta_description', $post->meta_description) }}</x-textarea>
