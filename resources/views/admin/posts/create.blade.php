    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Create a new blog post</p>
            </div>
                ...
                <div class="p-6 lg:p-8">
                    <form method="POST" action="{{ route('admin.posts.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="title" name="title" type="text" class="mt-2 block w-full" :value="old('title')" required autofocus />
                            <x-input-error :messages="$errors->get('title')" class="mt-2" />
                        </div>

                        <!-- Slug (optional) -->
                        <div class="mb-6">
                            <x-input-label for="slug" value="Slug (optional - auto-generated if empty)" class="text-gray-700 dark:text-gray-300" />
                            <x-text-input id="slug" name="slug" type="text" class="mt-2 block w-full font-mono" :value="old('slug')" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-textarea id="content" name="content" class="mt-2 block w-full" rows="12" required>{{ old('content') }}</x-textarea>
                            <x-input-error :messages="$errors->get('content')" class="mt-2" />
                        </div>

                        <!-- Excerpt -->
                        <div class="mb-6">
                            <x-input-label for="excerpt" value="Excerpt (optional - auto-generated if empty)" class="text-gray-700 dark:text-gray-300" />
                            <x-textarea id="excerpt" name="excerpt" class="mt-2 block w-full" rows="3">{{ old('excerpt') }}</x-textarea>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Leave empty to auto-generate from content</p>
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="tags" name="tags" type="text" class="mt-2 block w-full" :value="old('tags')" placeholder="tag1, tag2, tag3" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="meta_title" name="meta_title" type="text" class="mt-2 block w-full" :value="old('meta_title')" />
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Optional SEO meta title</p>
                        ...
                        <div class="mb-6">
                            ...
                            <x-textarea id="meta_description" name="meta_description" class="mt-2 block w-full" rows="3">{{ old('meta_description') }}</x-textarea>
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Optional SEO meta description</p>
