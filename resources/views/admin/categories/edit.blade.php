    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update category: {{ $category->name }}</p>
            </div>
                ...
                <div class="p-6 lg:p-8">
                    <form method="POST" action="{{ route('admin.categories.update', $category) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" name="name" type="text" class="mt-2 block w-full" :value="old('name', $category->name)" required autofocus />
                        ...
                        <div class="mb-6">
                            ...
                            <x-textarea id="description" name="description" class="mt-2 block w-full" rows="5">{{ old('description', $category->description) }}</x-textarea>
