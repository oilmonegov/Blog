<x-public-layout>
    <!-- Hero Section -->
    <div class="bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 text-white py-16 md:py-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 animate-fade-in">
                Welcome to Our Blog
            </h1>
            <p class="text-xl md:text-2xl text-purple-100 max-w-2xl mx-auto animate-slide-up">
